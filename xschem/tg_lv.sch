...
N 150 -630 200 -630 {lab=VDD}
N 150 -600 150 -570 {lab=VDD}
N 150 -570 200 -570 {lab=VDD}
N 150 -600 160 -600 {lab=VDD}
N 150 -630 150 -600 {lab=VDD}
N 140 -480 190 -480 {lab=VSS}
N 140 -450 140 -420 {lab=VSS}
N 140 -420 190 -420 {lab=VSS}
N 140 -450 150 -450 {lab=VSS}
N 140 -480 140 -450 {lab=VSS}
N 190 -420 190 -380 {lab=VSS}
N 200 -630 200 -600 {lab=VDD}
N 200 -680 200 -630 {lab=VDD}
N 190 -480 190 -450 {lab=VSS}
...
C {lab_pin.sym} 200 -680 2 0 {name=p13 sig_type=std_logic lab=VDD}
