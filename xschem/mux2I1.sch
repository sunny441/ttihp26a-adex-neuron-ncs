...
N -540 -410 -480 -410 {lab=sel}
N -340 -410 -300 -410 {lab=selbar}
...
C {lab_pin.sym} -540 -410 0 0 {name=p10 sig_type=std_logic lab=sel}
C {lab_pin.sym} -300 -410 2 0 {name=p11 sig_type=std_logic lab=selbar}
...
C {lab_pin.sym} -10 -360 0 0 {name=p22 sig_type=std_logic lab=selbar}
C {lab_pin.sym} -10 -80 0 0 {name=p14 sig_type=std_logic lab=sel}
